 ...
 * Use the [FridgeItemDetailFragment.newInstance] factory method to
...
class FridgeItemDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FridgeItemDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FridgeItemDetailFragment().apply {
